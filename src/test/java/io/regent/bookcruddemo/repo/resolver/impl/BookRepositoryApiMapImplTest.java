...
class BookRepositoryApiMapImplTest {
    ...
    void retrieveBookFailsForInvalidBookReference() {
        ...
        BookException exception = assertThrows(BookException.class, () -> bookService.retrieveBook(invalidBookReference));
    ...
    void retrieveBookFailsForBookNotInStore() {
        ...
        BookException exception = assertThrows(BookException.class, () -> bookService.retrieveBook(referenceForBookNotInStore));
        String expectedErrorMessage = exception.getMessage();
